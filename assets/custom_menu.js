jQuery(document).ready(function ($) {
    ...
    $(".site-header").append('<div class="subMenuWrapper" style="position: absolute;"></div>'); // Ensure position is set to absolute
    ...
    $(".site-header ul.menu > li").on("mouseenter", function () {
      ...
      if (!$this.find("a").first().is("#bookDemo")) {
        ...
        $(".subMenuWrapper")
          ...
          .css("left", $this.offset().left + "px"); // Adjusted for absolute positioning
